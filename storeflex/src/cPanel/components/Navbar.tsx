                ...
                <Dropdown.Menu className="preview-list navbar-dropdown">
                  ...
                  <Dropdown.Item className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                    <div className="preview-thumbnail">
                      <img src="/cpanel/images/faces/face4.jpg" alt="user" className="profile-pic"/>
                    </div>
                  ...
                  <Dropdown.Item className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                    <div className="preview-thumbnail">
                      <img src="/cpanel/images/faces/face2.jpg" alt="user" className="profile-pic"/>
                    </div>
                    <div className="preview-item-content d-flex align-items-start flex-column justify-content-center">
                  ...
                  <Dropdown.Item className="dropdown-item preview-item" onClick={evt =>evt.preventDefault()}>
                    <div className="preview-thumbnail">
                      <img src="/cpanel/images/faces/face3.jpg" alt="user" className="profile-pic"/>
                    </div>
                    <div className="preview-item-content d-flex align-items-start flex-column justify-content-center">
              ...
              <Dropdown >
                <Dropdown.Toggle className="nav-link">
                  <div className="nav-profile-img">
                    <img src="/cpanel/images/faces/face1.jpg" alt="user"/>
