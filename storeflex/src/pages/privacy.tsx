            ...
            <div className='c-box-shadow-blue'>
                <Box className='m-top-md m-bot-md m-left-md m-right-md'>
                    <div>
                        ...
                        <p> This Privacy Policy<b> (“Policy”) </b>describes the manner in which Optzzchain, Inc. <b>(“Store Flex”</b>, “<b>we</b>,” or “<b>us</b>”) and our website at www.storeflex.com (the “<b>Site</b>”), as well as all related websites, networks, applications, and other services provided by us and on which a link to this Policy is displayed (collectively, together with the Site, our “<b>Service</b>”) use and collect data from individuals. This Policy, which is incorporated into and is subject to the Store Flex Terms of Service, describes the information that we gather from you on the Service, how we use and disclose such information, and the steps we take to protect such information.</p>
                        <b>Information We Collect on the Service:</b>
                        <ul></ul><li><b>User-provided Information. </b><p>When you use the Service, we may collect information about you, including your name, email address, mailing address, mobile phone number, credit card or other billing information, your date of birth, geographic area, or preferences and we may link this information with other information about you. You may provide us with information in various ways on the Service. For example, you provide us with information when you register for an account, use the Service, make a purchase on the Service, or send us customer service-related requests. When you make payments through the Service, you may need to provide financial account information, such as your credit card number, to our third-party service providers, including Stripe. We do not collect or store such information, though we may receive information about completed transactions that does not include credit card or bank account numbers</p></li>

                        <li><b>Cookies and Automatically Collected Information.</b><p>When you use the Service, we may send one or more cookies – small text files containing a string of alphanumeric characters – to your device. We may use both session cookies and persistent cookies. A session cookie disappears after you close your browser. A persistent cookie remains after you close your browser and may be used by your browser on subsequent visits to the Service. Please review your web browser “Help" file to learn the proper way to modify your cookie settings. Please note that if you delete, or choose not to accept, cookies from the Service, you may not be able to utilize the features of the Service to their fullest potential. We may use third party cookies on our Service as well. For instance, we use Google Analytics to collect and process certain analytics data. Google provides some additional privacy options described at www.google.com/policies/privacy/partners/ regarding Google Analytics cookies. Store Flex does not process or respond to web browsers’ “do not track” signals or other similar transmissions that indicate a request to disable online tracking of users who visit our Site or who use our Service.</p></li>
                        ...
                        <li><b>Location Information. </b><p>We may obtain information about your physical location, such as by use of GPS and other geolocation features in your device, or by inference from other information we collect (for example, your IP address indicates the general geographic region from which you are connecting to the Internet).</p></li>

                        <li><b>Third Party Web Beacons and Third Party Buttons. </b><p>We may display third-party content on the Service, including third-party advertising. Third-party content may use cookies, web beacons, or other mechanisms for obtaining data in connection with your viewing of the third party content on the Service. Additionally, we may implement third party buttons (such as Facebook “like” or “share” buttons) that may function as web beacons even when you do not interact with the button. Information collected through third-party web beacons and buttons is collected directly by these third parties, not by Store Flex. Information collected by a third party in this manner is subject to that third party’s own data collection, use, and disclosure policies.</p></li>

                        <li><b>Information from Other Sources.</b><p>We may obtain information from third parties and sources other than the Service, such as our partners and advertisers.</p></li>
                        <b>How We Use the Information We Collect</b>. We use information we collect on the Service in a variety of ways in providing the Service and operating our business, including the following:
                        <p><li>We use the information that we collect on the Service to operate, maintain, enhance and provide all features of the Service, to provide services and information that you request, to respond to comments and questions and otherwise to provide support to users, and to process and deliver entries and rewards in connection with promotions that may be offered from time to time on the Service.</li></p>

                        <li>We will use information regarding Listings to gather information about the supply of Facility Services across geography and time, and will use information regarding user’s searches to track demand for Facility Services.</li>

                        <p><li>We use the information that we collect on the Service to understand and analyze the usage trends and preferences of our users, to improve the Service, and to develop new products, services, features, and functionality.</li></p>

                        <p><li>We may use your email address or other information we collect to contact you for administrative purposes such as customer service or to send communications, including updates on promotions and events, relating to products and services offered by us and by third parties.</li></p>

                        <p><li>We may use cookies and automatically collected information to: (i) personalize our Service, such as remembering information about you so that you will not have to re-enter it during your visit or the next time you visit the Service; (ii) provide customized advertisements, content, and information; (iii) monitor and analyze the effectiveness of the Service and third-party marketing activities; (iv) monitor aggregate site usage metrics such as total number of visitors and pages viewed; and (v) track your entries, submissions, and status in any promotions or other activities on the Service.</li></p>
                        <b>When We Disclose Information</b>. Except as described in this Policy, we will not disclose information about you that we collect on the Service to third parties without your consent. We may disclose information to third parties if you consent to us doing so, as well as in the following circumstances:

                        <p><li>Any information that you voluntarily choose to include in a publicly accessible area of the Service will be available to anyone who has access to that content, including other users.</li>

                            <li>When an Operator and a Client choose to transact via the Service, we will share information about each user with the other in order to facilitate their use of the Service. Operator’s information may include contact information and information about Facilities. Client’s information may include contact information, information about Client’s Items, and which Facility Services Client needs.</li>
                        ...
                        <b>Marketing</b>
                        <p>We do not rent, sell, or share personal information about you that we collect on the Site with other people or unaffiliated companies for their direct marketing purposes, unless we have your permission. We may allow access to data collected by the Service to enable the delivery of online advertising on the Service, or to send you information we think may be useful or relevant to you.</p>
                        ...
                        <p>Residents of California have the right to request a disclosure describing what types of personal information we have shared with third parties for their direct marketing purposes, and with whom we have shared it, during the preceding calendar year. You may request a copy of that disclosure by contacting us at <a href="mailto:support@storeflex.com"> support@storeflex.com</a>.</p>
                        <b>How to Contact Us</b>
                        <p>Please contact us with any questions or comments about this Policy, information we have collected or otherwise obtained about you, our use and disclosure practices, or your consent choices by email at <a href="mailto:support@storeflex.com"> support@storeflex.com</a>.</p>
                        <p>Optzzchain, Inc.</p>
                        <p>11400 W. Olympic Blvd, Suite 1400</p>
                        <p><p><p>Los Angeles, California, 90064</p></p></p>
